...
我有四年多Web开发的经验。一年三星数据系统有限公司的内部网站开发经验; 近三年[澳洲第一商业地产网站](https://www.realcommercial.com.au)网站的开发与维护和带团队的经验; 近半年带团队从零开始做ThoughtWorks校园新招聘网站的经验。

技术上，Java/Ruby/Node.js相关Web项目可独立从零开始开发；掌握了基础设施管理(包括但不限于基础设施即代码，AWS资源与工具，docker, Ansible，负载均衡，0宕机部署等)。以下的每项都有实际经验：数据库的1主+N备读写分离管理；数据数据到搜索引擎的实时同步；持续集成与持续部署；网站的A/B测试；CDN(Akamai)的配置；网站性能调优；SEO优化；产品环境的运行/访问监控；庞大单体项目拆分为微服务架构；BFF架构；Serverless架构等。
...
ThoughtWorks是一家追求技术卓越的企业，我有幸2014年加入并在很多能力维度上有了进步。
### ThoughtWork校园招聘网站
...
- http://join.thoughtworks.com 首页相关Responsive页面，支持电脑桌面端显示和手机端显示
...
- DevOps相关：AWS/Docker/Ansible/NewRelic/Shell/Bamboo/Jenkins/阿里云/Daocloud/七牛

- 编辑器：IntelliJ IDEA/Ruby Mine/Atom/Sublime/vim

- 英语：熟练的口语沟通、能听懂无字幕的技术视频(Udemy)
